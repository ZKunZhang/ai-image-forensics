...
const STRINGS = {
    ...
    'conv.runBatchBtn':     { zh: '批量转换 ${n} 张',                                                   en: 'Convert ${n} images' },
    'conv.reanalyze':       { zh: '重新分析',                                                           en: 'Re-analyze' },
    'conv.download':        { zh: '下载 (${size})',                                                     en: 'Download (${size})' },
    'conv.processing':      { zh: '正在处理...',                                                         en: 'Processing...' },
    'conv.processingFile':  { zh: '正在转换: ${name}',                                                  en: 'Converting: ${name}' },
    'conv.batchProcessing': { zh: '正在处理第 ${done}/${total} 张...',                                  en: 'Processing ${done}/${total}...' },
    'conv.batchDone':       { zh: '${n} 张图片转换完成',                                                 en: '${n} images converted' },
    'conv.batchFailed':     { zh: '${n} 张转换失败',                                                     en: '${n} failed' },
    'conv.status.pending':  { zh: '等待',                                                               en: 'Waiting' },
    'conv.status.running':  { zh: '转换中',                                                             en: 'Converting' },
    'conv.status.done':     { zh: '完成',                                                               en: 'Done' },
    'conv.status.failed':   { zh: '失败',                                                               en: 'Failed' },
    'conv.downloadHint':    { zh: '处理结果已准备好,点击下方文件即可下载。',                              en: 'Results are ready. Click a file below to download it.' },
    ...
    // Footer
    'foot.mit':             { zh: 'MIT · 开源于 <a href="https://github.com/ZKunZhang/ai-image-forensics" target="_blank" rel="noopener">GitHub</a>', en: 'MIT · Open source on <a href="https://github.com/ZKunZhang/ai-image-forensics" target="_blank" rel="noopener">GitHub</a>' },
    ...
    'seo.title':            { zh: 'AI 图片检测 · C2PA / SynthID / Sora / Gemini / Midjourney 溯源 · AI Image Forensics',
                              en: 'AI Image Detector · C2PA / SynthID / Sora / Gemini / Midjourney · AI Image Forensics' },
